        ...
        preset: 'colors', background: {
          color: 'black',
            ...
            interactivity: {
              ...
              modes: {
                bubble:
                    {distance: 40, duration: 2, opacity: 8, size: 6, speed: 3}
              }
            },
            particles: {
              color: {
              ...
              number:
                  {density: {enable: false, area: 2000}, limit: 0, value: 200},
              opacity: {
                animation:
                    {enable: true, minimumValue: 0.05, speed: 2, sync: false},
                random: false,
                value: 1
              },
              shape: {type: 'circle'},
              size: {
                animation:
                    {enable: false, minimumValue: 0.1, speed: 40, sync: false},
                random: true,
                value: 1
              }
            },
